...
static PyMethodDef CpipelibMethods[] = {
...
static struct PyModuleDef cpipelibmodule = {
   PyModuleDef_HEAD_INIT, "cpipelib", NULL, -1, CpipelibMethods
};

PyMODINIT_FUNC
PyInit_cpipelib(void)
{
    return PyModule_Create(&cpipelibmodule);
}